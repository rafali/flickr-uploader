...
/**
 * Class representing metadata about a Flickr photo. Instances do not actually contain the photo data, however you can obtain the photo data by calling {@link PhotosInterface#getImage(Photo, int)} or
...
public class Photo {
	...
	/**
	 * @return A placeId
	 * @see com.gmail.yuyang226.flickr.places.PlacesInterface#resolvePlaceId(String)
	 */
	 ...
	 * 
	 * @param sizes
	 * @see com.gmail.yuyang226.flickr.photos.PhotosInterface#getSizes(String)
	 */
